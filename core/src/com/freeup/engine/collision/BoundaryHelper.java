...
//		reducePixelInnerConvexPolygon();
	...
	/**
	 * Đầu tiên tìm 1 điểm có màu trên pixmap.
	 * Từ đó tìm lan ra tạo thành đường bao.
	 */
	...
	/**
	 * Thực hiện vẽ đường bao.
	 */
	private void veBao() {
		vStart = new Vector2(v1);//Gán điểm bắt đầu.
		lV.add(new Vector2(v1));//Gán điểm bắt đầu đường bao vào list.
		do {
			timPointTiep();
			if ((v2.x != vStart.x) | (v2.y != vStart.y)) { //Nếu bao chưa hết vòng.
...
//		System.out.println("lV.leng : " + lV.size());
	...
	/**
	 * Tìm và loại bỏ những pixel nằm phía bên trong
	 * Đó là những pixel không quan trọng.
	 * Kết quả tạo ra 1 convex Polygon.
	 */
...
//		System.out.println("lV.size() : " + lV.size());
	...
	/**
	 * Kiểm tra xem 1 pixel có trong suốt 100% không.
	 * @return true:trong suốt, false:có màu.
	 */
