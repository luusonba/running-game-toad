...
public class GameRenderer {
	...
	private TextureRegion bg, grass, birdMid, bar, ready,
			zbLogo, gameOver, highScore, scoreboard, star, noStar, retry;
	...
	private void drawPipes() {
		...
		int height = 40;
		batcher.draw(bar, pipe1.getX(), pipe1.getY() + midPointY + 66 - height,
				pipe1.getWidth(), height);
		...
		batcher.draw(bar, pipe2.getX(), pipe2.getY() + midPointY + 66 - height,
				pipe2.getWidth(), height);
		...
		batcher.draw(bar, pipe3.getX(), pipe3.getY() + midPointY + 66 - height,
				pipe2.getWidth(), height);
	}
